...
<div class="container">
    <ul class="pagination">
        <li>
            <a href="${contextPath}/search-product-filter/result/show?currentPage=1">1</a>
        </li>
        <li>
            <a href="${contextPath}/search-product-filter/result/show?currentPage=2">2</a>
        </li>
        <li>
            <a href="${contextPath}/search-product-filter/result/show?currentPage=3">3</a>
        </li>
    </ul>
</div>
